...
- **기준일:** 2026-09-14 (기존 9/3 로드맵의 완료 상태 갱신)
- **기준 브랜치:** `feat/dashboard-stock-extension-20260727`
- **기준 커밋:** `7283865dcf8709ec9673404b0321adfe208c65be` (발주 1차)
...
| 작업 | 상태 | 우선순위 | 착수 조건 또는 비고 |
| --- | --- | --- | --- |
| Snapshot/Dashboard 후속 검증·성능·HY000 관찰 | 다음 | P0 | 발주 1차와 별도 범위. 기존 미커밋 변경 및 운영본 보호 |
...
| 작업 | 상태 | 우선순위 | 착수 조건 또는 비고 |
| --- | --- | --- | --- |
| 계약단가 조회 및 발주 가격 연결 | 완료 | 운영 유지 | 기준일 유효 계약 및 적용처 코드, 계약 시작일 기간 누출 수정 |
| 발주 계산·NLQ 1차 | 완료 | 운영 유지 | 2026-09-14 배포/Smoke 및 공식 문서 마감 |
| 발주 ERP 등록·확정 | 백로그 | 별도 승인 | 계산과 구분. ERP write/사용자 승인·정산 계약 확정 전 착수하지 않음 |
...
발주 1차 계산은 완료됐으며 실제 ERP 등록을 포함하는 완료 상태로 해석하지 않는다.
공식 결과는 [발주 1차 Closeout](../04_test_results/ORDER_CALCULATION_PHASE1_CLOSEOUT_20260914.md)을 따른다.

...
ORDER_CALCULATION = ErpTableFeatureSpec(
    ...
    filters=(*RDDBC170_RDDBC180.filters,
        ErpFilterSpec(
            "order_staff_nm", "발주담당자",
            "최종 발주처코드 -> Rddbc030.Rd03_Sales_Man -> Rddbc060.Rd06_User_Nm", "text",
        ),
        ErpFilterSpec(
            "pharma_staff_nm", "제약담당자",
            "Rddbc040.Rd04_Ven_Cd -> Rddbc030.Rd03_Sales_Man -> Rddbc060.Rd06_User_Nm", "text",
        ),
    ),

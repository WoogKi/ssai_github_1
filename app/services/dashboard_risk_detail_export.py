...
_AMOUNT_COLUMNS = {"현재재고금액", "재고평가단가", "위험보정부족예상금액", "최근6완료월순매입금액", "긴급부족금액", "부족주의금액", "전체위험보정부족금액"}
_QTY_COLUMNS = {"현재재고수량", "당월현재출고수량", "당월기준예상출고수량", "진행속도기준월말예상출고수량", "위험보정예상출고수량", "위험보정잔여예상수요", "위험보정부족예상수량", "최근6완료월순입고수량", "위험보정부족수량"}

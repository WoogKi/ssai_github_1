...
def _default_pinned_cols(
    ...
    *,
    ...
    is_analysis_like = (
        ...
        or str(meta.get("analysis_type") or "").strip() in {"sales_trend", "sales_forecast", "customer_sales_forecast", "manufacturer_sales_trend", "manufacturer_sales_trend_summary", "stock_shortage"}
